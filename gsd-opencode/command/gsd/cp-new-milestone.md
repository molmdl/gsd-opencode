...
", subagent_type="cp-gsd-project-researcher", model="{researcher_model}", description="Stack research")
...
", subagent_type="cp-gsd-project-researcher", model="{researcher_model}", description="Features research")
...
", subagent_type="cp-gsd-project-researcher", model="{researcher_model}", description="Architecture research")
...
", subagent_type="cp-gsd-project-researcher", model="{researcher_model}", description="Pitfalls research")
```
...
", subagent_type="cp-gsd-research-synthesizer", model="{synthesizer_model}", description="Synthesize research")
```
...
", subagent_type="cp-gsd-roadmapper", model="{roadmapper_model}", description="Create roadmap")
```
...
- Re-spawn roadmapper with revision context:
  ...
  ", subagent_type="cp-gsd-roadmapper", model="{roadmapper_model}", description="Revise roadmap")
  ```
