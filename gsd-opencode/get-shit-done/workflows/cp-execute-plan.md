...
2. Use Task tool with subagent_type="cp-gsd-executor" and model="{executor_model}":
...
2. For each segment in order:
   ...
   B. If routing = Subagent:
      ```
      Spawn Task tool with subagent_type="cp-gsd-executor" and model="{executor_model}":
